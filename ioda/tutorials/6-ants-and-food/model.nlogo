...
to init-agents
  ...
  set-default-shape food "tile stones"
  ...
  create-food food-qty [init-food]
  create-ants nb-ants [ init-ant ]
  set pile1 sum [count food-here] of patches with [shade-of? pcolor red]
  set pile2 sum [count food-here] of patches with [shade-of? pcolor orange]
  set pile3 sum [count food-here] of patches with [shade-of? pcolor yellow]
...
to init-food
  ...
  ifelse (any? other food in-radius 2)
    [ set quality (mean [quality] of other food in-radius 2) + (random 5) - (random 5) ]
