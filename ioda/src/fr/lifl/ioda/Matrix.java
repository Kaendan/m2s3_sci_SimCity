 ...
 */
public class Matrix implements org.nlogo.api.ExtensionObject {    
	...
	while ((line = in.readLine()) != null) {
		...
		priority = new Double(t.nextToken()) ;
		if (nb > 3) {
			...
			if (nb > 4) {
			    distance = new Double(t.nextToken()) ;
			    if (nb > 5) {
    ...
    //----------------------------------------------------------------
    public static class MatrixMake extends DefaultReporter {
    ...
    //----------------------------------------------------------------
    public static class MatrixView extends DefaultReporter {
	public Syntax getSyntax() {
    ...
    //----------------------------------------------------------------
    public static class GetMatrixLine extends DefaultReporter {
	public Syntax getSyntax() {
	    return Syntax.reporterSyntax(new int[] {Syntax.WildcardType(), Syntax.AgentsetType()}, Syntax.ListType()) ;
	}
	public String getAgentClassString() { return "OTPL" ; }
	public Object report(Argument args[], Context context) 
	    throws ExtensionException, LogoException {
    ...
    //----------------------------------------------------------------
    public static class GetBreedTargets extends DefaultReporter {
	public Syntax getSyntax() {
	    return Syntax.reporterSyntax(new int[] {Syntax.AgentsetType()}, Syntax.ListType()) ;
	}
	public String getAgentClassString() { return "OTPL" ; }
	public Object report(Argument args[], Context context) 
	    throws ExtensionException, LogoException {
    ...
    //----------------------------------------------------------------
    public static class IsActive extends DefaultReporter {
	public Syntax getSyntax() {
    ...
    //----------------------------------------------------------------
    public static class IsPassive extends DefaultReporter {
	public Syntax getSyntax() {
	    return Syntax.reporterSyntax(new int[] {}, Syntax.BooleanType()) ;
	}
	public String getAgentClassString() { return "TP" ; }
    ...
    //----------------------------------------------------------------
    public static class IsLabile extends DefaultReporter {
	public Syntax getSyntax() {
	    return Syntax.reporterSyntax(new int[] {}, Syntax.BooleanType()) ;
	}
	public String getAgentClassString() { return "TP" ; }
    ...
    //----------------------------------------------------------------
    public static class ActiveAgents extends DefaultReporter {
	public Syntax getSyntax() {
    ...
    //----------------------------------------------------------------
    public static class ActiveAgentsWithTargets extends DefaultReporter {
	public Syntax getSyntax() {
	    return Syntax.reporterSyntax(new int[] {}, Syntax.ListType()) ;
	}
	public String getAgentClassString() { return "OTPL" ; }
    ...
    //----------------------------------------------------------------
    public static class PassiveAgents extends DefaultReporter {
	public Syntax getSyntax() {
	    return Syntax.reporterSyntax(new int[] {}, Syntax.ListType()) ;
	}
	public String getAgentClassString() { return "OTPL" ; }
    ...
    //----------------------------------------------------------------
    public static class LabileAgents extends DefaultReporter {
	public Syntax getSyntax() {
	    return Syntax.reporterSyntax(new int[] {}, Syntax.ListType()) ;
	}
	public String getAgentClassString() { return "OTPL" ; }
    ...
    //----------------------------------------------------------------
    public static class GetInteractionMatrix extends DefaultReporter {
	public Syntax getSyntax() {
	    return Syntax.reporterSyntax(new int[] {}, Syntax.WildcardType()) ;
	}
	public String getAgentClassString() { return "OTPL" ; }
    ...
    //----------------------------------------------------------------
    public static class SetInteractionMatrix extends DefaultCommand {
	public Syntax getSyntax() {
    ...
    //----------------------------------------------------------------
    public static class GetUpdateMatrix extends DefaultReporter {
	public Syntax getSyntax() {
	    return Syntax.reporterSyntax(new int[] {}, Syntax.WildcardType()) ;
	}
	public String getAgentClassString() { return "OTPL" ; }
    ...
    //----------------------------------------------------------------
    public static class SetUpdateMatrix extends DefaultCommand {
	public Syntax getSyntax() {
	    return Syntax.commandSyntax(new int[] {Syntax.WildcardType()}) ;
	}
	public String getAgentClassString() { return "OTPL" ; }
    ...
    //----------------------------------------------------------------
    public static class AddAssignation extends DefaultCommand {
	public Syntax getSyntax() {
    ...
    //----------------------------------------------------------------
    public static class RemoveAssignation extends DefaultCommand {
	public Syntax getSyntax() {
	    return Syntax.commandSyntax(new int[] {Syntax.WildcardType(), Syntax.WildcardType()}) ;
	}
	public String getAgentClassString() { return "OTPL" ; }
    ...
    //----------------------------------------------------------------
    public static class LoadMatrices  extends DefaultCommand {
	public Syntax getSyntax() {
    ...
    //----------------------------------------------------------------
    public static class ClearMatrices  extends DefaultCommand {
	public Syntax getSyntax() {
    ...
    //----------------------------------------------------------------
    public static class MatrixToList extends DefaultReporter {
	public Syntax getSyntax() {
	    return Syntax.reporterSyntax(new int[] {Syntax.WildcardType()}, Syntax.ListType()) ;
	}
	public String getAgentClassString() { return "OTPL" ; }
    ...
    //----------------------------------------------------------------
    public static class PrintInteractionMatrix extends DefaultReporter {
	public Syntax getSyntax() {
    ...
    //----------------------------------------------------------------
    public static class PrintUpdateMatrix extends DefaultReporter {
	public Syntax getSyntax() {
	    return Syntax.reporterSyntax(new int[] {}, Syntax.StringType()) ;
	}
	public String getAgentClassString() { return "OTPL" ; }
