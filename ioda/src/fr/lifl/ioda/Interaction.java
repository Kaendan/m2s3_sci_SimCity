 ...
 * contents &copy; 2008-2015 Sébastien PICAULT and Philippe
 * MATHIEU<br> Centre de Recherche en Informatique, Signal et
 * Automatique de Lille (CRIStAL), UMR CNRS 9189<br> Université de
 * Lille (Sciences et Technologies) – Cité Scientifique,
 * F-59655 Villeneuve d'Ascq Cedex, FRANCE.<br> Web Site: <a
 * href="http://www.lifl.fr/SMAC/projects/ioda">http://www.lifl.fr/SMAC/projects/ioda</a></p>
 ...
 * along with the IODA NetLogo extension. If not, see 
 * <a href="http://www.gnu.org/licenses">http://www.gnu.org/licenses</a>.</p>
 *
 * @author Sébastien Picault
 * @author Philippe Mathieu
 *
 * @see <a href="http://www2.lifl.fr/SMAC/projects/ioda/">The IODA Webpage</a>
 * @version IODA Extension 2.3 - Oct. 2014
 */
public class Interaction implements org.nlogo.api.ExtensionObject {    
	...
	for (Object o: this.getCondition()) {
	    LogoList l = (LogoList) o ;
	    String s = "  CONDITION\t" ;
	    for (Object o2: l)
		s += o2 + " " ;
	...
	if ((i.getTrigger().size() != this.getTrigger().size()) || 
	    (!(i.getTrigger().containsAll(this.getTrigger()) && (this.getTrigger().containsAll(i.getTrigger())))) ||
	    (i.getCondition().size() != this.getCondition().size()) ||
	    (!(i.getCondition().containsAll(this.getCondition()) && (this.getCondition().containsAll(i.getCondition())))))
	    return false ;
	...
	if (sourceBreed.equals("patches")) {
	    sourceIdentifier.add(new Double(((Patch)source).pxcor())) ;
	    sourceIdentifier.add(new Double(((Patch)source).pycor())) ;
	} else sourceIdentifier.add(new Double(source.id())) ;
	if (!targetBreed.equals("nobody")) {
	    if (targetBreed.equals("patches")) {
		targetIdentifier.add(new Double(((Patch)target).pxcor())) ;
		targetIdentifier.add(new Double(((Patch)target).pycor())) ;
	    } else targetIdentifier.add(new Double(target.id())) ;
	}
	
	Iterator<Object> it2 = reporters.iterator() ;
	while (it2.hasNext()) {
	    ...
	    Iterator<Object> it = tmp2.iterator() ;
	    while (it.hasNext()) {
	...
	if (!targetBreed.equals("nobody")) {
	    if (listTarget) {
		Iterator<Object> itt = ((LogoList)target).iterator() ;
		while (itt.hasNext()) {
		    LogoListBuilder tgtlist = new LogoListBuilder() ;
		    Object atgt = itt.next() ;
		    if (targetBreed.equals("patches")) {
			tgtlist.add(new Double(((Patch)atgt).pxcor())) ;
			tgtlist.add(new Double(((Patch)atgt).pycor())) ;
		    } else tgtlist.add(new Double(((Turtle)atgt).id())) ;
		...
		if (targetBreed.equals("patches")) {
		    targetIdentifier.add(new Double(((Patch)target).pxcor())) ;
		    targetIdentifier.add(new Double(((Patch)target).pycor())) ;
		} else targetIdentifier.add(new Double(((Turtle)target).id())) ;
	    }
	}
    ...
    //----------------------------------------------------------------
    public static class LoadInteractions  extends DefaultCommand {
    ...
    //----------------------------------------------------------------
    public static class SetExclusiveInteractions  extends DefaultCommand {
	public Syntax getSyntax() {
    ...
    //----------------------------------------------------------------
    public static class SetExclusive  extends DefaultCommand {
	public Syntax getSyntax() {
	    return Syntax.commandSyntax(new int[] {Syntax.WildcardType(), Syntax.BooleanType()}) ;
	}
	public String getAgentClassString() { return "OTPL" ; }
	public void perform(Argument args[], Context context) 
	    throws ExtensionException, LogoException {
		...
		throw new ExtensionException("not an interaction: " + org.nlogo.api.Dump.logoObject(arg0)) ;
    ...
    //----------------------------------------------------------------
    public static class IsExclusive extends DefaultReporter {
	public Syntax getSyntax() {
    ...
    //----------------------------------------------------------------
    public static class InteractionName extends DefaultReporter {
	public Syntax getSyntax() {
    ...
    //----------------------------------------------------------------
    public static class InteractionMake extends DefaultReporter {
	public Syntax getSyntax() {
	    return Syntax.reporterSyntax(new int[] {Syntax.StringType(), Syntax.ListType(), Syntax.ListType(), Syntax.ListType()}, 
					 Syntax.WildcardType()) ;
	}
	public String getAgentClassString() { return "OTPL" ; }
	public Object report(Argument args[], Context context) 
    ...
    //----------------------------------------------------------------
    public static class InteractionFromList extends DefaultReporter {
	public Syntax getSyntax() {
    ...
    //----------------------------------------------------------------
    public static class GetInteractions extends DefaultReporter {
	public Syntax getSyntax() {
	...
	public Object report(Argument args[], Context context) 
        ...
        //----------------------------------------------------------------
    public static class PrintInteractions extends DefaultReporter {
	public Syntax getSyntax() {
    ...
    //----------------------------------------------------------------
    public static class GetInteraction extends DefaultReporter {
	public Syntax getSyntax() {
    ...
    //----------------------------------------------------------------
    public static class EvalTrigger extends DefaultReporter {
	public Syntax getSyntax() {
	    return Syntax.reporterSyntax(new int[] {Syntax.WildcardType(), (Syntax.AgentType() | Syntax.NobodyType())}, Syntax.ListType()) ;
	}
    ...
    //----------------------------------------------------------------
    public static class EvalCondition extends DefaultReporter {
	public Syntax getSyntax() {
	    return Syntax.reporterSyntax(new int[] {Syntax.WildcardType(), (Syntax.AgentType() | Syntax.NobodyType())}, Syntax.ListType()) ;
	}
	public String getAgentClassString() { return "TP" ; }
    ...
    //----------------------------------------------------------------
    public static class PerformActions extends DefaultReporter {
	public Syntax getSyntax() {
	    return Syntax.reporterSyntax(new int[] {Syntax.WildcardType(), (Syntax.AgentType() | Syntax.ListType() | Syntax.NobodyType())}, Syntax.ListType()) ;
	}
	public String getAgentClassString() { return "TP" ; }
	public Object report(Argument args[], Context context) 
	    throws ExtensionException, LogoException {
	    ...
	    if (target != null) {
		if ((target.equals(Nobody.class)) || (target instanceof Nobody) || (org.nlogo.api.Dump.logoObject(target).toString().equals("nobody"))) 
		    target = null ;
		else 
		if (!((target instanceof Turtle) || (target instanceof Patch) 
		      || (target instanceof LogoList)))
		    throw new ExtensionException("Second argument of perform-actions ("+org.nlogo.api.Dump.logoObject(target)+") should be a turtle or patch or a list or nobody") ;
	    }
