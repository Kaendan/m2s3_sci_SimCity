 ...
 */
public class Assignation implements Comparable<Assignation>, org.nlogo.api.ExtensionObject {    
	...
	return (new Double(this.getPriority())).compareTo(a.getPriority()) ;
    }


    //----------------------------------------------------------------
    public static class AssignationFromList extends DefaultReporter {
    ...
    //----------------------------------------------------------------
    public static class AssignationToList extends DefaultReporter {
	public Syntax getSyntax() {
    ...
    //----------------------------------------------------------------
    public static class GetSourceBreed extends DefaultReporter {
	public Syntax getSyntax() {
	    return Syntax.reporterSyntax(new int[] {Syntax.WildcardType()}, Syntax.AgentsetType()) ;
	}
	public String getAgentClassString() { return "OTPL" ; }
	public Object report(Argument args[], Context context) 
	    throws ExtensionException, LogoException {
   ...
   //----------------------------------------------------------------
    public static class GetTargetBreed extends DefaultReporter {
	public Syntax getSyntax() {
	    return Syntax.reporterSyntax(new int[] {Syntax.WildcardType()}, (Syntax.AgentsetType()|Syntax.NobodyType())) ;
	}
	public String getAgentClassString() { return "OTPL" ; }
	public Object report(Argument args[], Context context) 
	    throws ExtensionException, LogoException {
		...
		return org.nlogo.api.Nobody.class ;
	    return IodaExtension.findBreedNamed(context, tgtBreed) ;
	}
    }    

    //----------------------------------------------------------------
    public static class IsDegenerate extends DefaultReporter {
	public Syntax getSyntax() {
    ...
    //----------------------------------------------------------------
    public static class GetPriority extends DefaultReporter {
	public Syntax getSyntax() {
    ...
    //----------------------------------------------------------------
    public static class GetDistance extends DefaultReporter {
	public Syntax getSyntax() {
	    return Syntax.reporterSyntax(new int[] {Syntax.WildcardType()}, Syntax.NumberType()) ;
	}
	public String getAgentClassString() { return "OTPL" ; }
    ...
    //----------------------------------------------------------------
    public static class TargetSelectionMethod extends DefaultReporter {
	public Syntax getSyntax() {
    ...
    //----------------------------------------------------------------
    public static class SetTargetSelectionMethod extends DefaultCommand {
	public Syntax getSyntax() {
